...
public class DriveBase extends SubsystemBase {
  ...
  public DriveBase() {
    ...
    rightDrive3.setSmartCurrentLimit(55, 20);
    leftDrive1.setSmartCurrentLimit(55, 20);
    leftDrive2.setSmartCurrentLimit(55, 20);
    leftDrive3.setSmartCurrentLimit(55, 20);
    ...
    leftDrive3PidController.setFF(kFF);
    ...
    rightDrive3PidController.setFF(kFF);
  ...
  public void DPPShifter(String gear) {
    if(gear.toUpperCase().equals("LOW")) {
      ...
      leftEncoders[2].setPositionConversionFactor(Constants.DriveConstants.LOW_GEAR_LEFT_DPP);
      ...
      rightEncoders[2].setPositionConversionFactor(Constants.DriveConstants.LOW_GEAR_RIGHT_DPP);
    } else if(gear.toUpperCase().equals("HIGH")) {
      ...
      leftEncoders[2].setPositionConversionFactor(Constants.DriveConstants.HIGH_GEAR_LEFT_DPP);
      ...
      rightEncoders[2].setPositionConversionFactor(Constants.DriveConstants.HIGH_GEAR_RIGHT_DPP);
    }
  } 
  ...
  */
  ...
  public void driveToPos(double distance) {
    ...
    leftDrive3PidController.setReference(distance, CANSparkMax.ControlType.kPosition);
    ...
    rightDrive3PidController.setReference(distance, CANSparkMax.ControlType.kPosition);
