...
public class SinglePieceAutoRedRight extends SequentialCommandGroup {
  /**
   * Add your docs here.
   */
  ...
  public SinglePieceAutoRedRight(double DistanceInput, double SpeedInput, DriveBase passedDrivebase, Claw passedClaw, Arm passedArm) {
