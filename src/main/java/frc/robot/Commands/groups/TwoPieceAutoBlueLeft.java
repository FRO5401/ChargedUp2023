...
public class TwoPieceAutoBlueLeft extends SequentialCommandGroup {
  /**
   * Add your docs here.
   */
  ...
  public TwoPieceAutoBlueLeft(double DistanceInput, double SpeedInput, DriveBase passedDrivebase) {
