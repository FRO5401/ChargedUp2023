...
public class TwoPieceAutoRedRightClawGround extends SequentialCommandGroup {
  /**
   * Add your docs here.
   */
  ...
  public TwoPieceAutoRedRightClawGround(double DistanceInput, double SpeedInput, DriveBase passedDrivebase, Claw passedClaw, Arm passedArm) {
    ...
    new AutoTurn(SpeedInput, DistanceInput, passedDrivebase),
